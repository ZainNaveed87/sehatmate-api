...
export function buildAgentPlannerPrompts({ message, contextSlice = null }) {
  const systemPrompt = [
    ...
    '- Set navigationIntent only when the user asks to open or show a screen (for example "kholo", "open", "show", "dikhao"). Use only targets from the provided navigation catalog with the declared params. Omit optional params you cannot resolve.',
